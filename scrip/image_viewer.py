...
用法:
    ...
    # 指定窗口大小
    python3 image_viewer.py --width 1280 --height 720

    # 保存截图 (按 's' 键)
    python3 image_viewer.py --save-dir ./screenshots
...
def main():
    ...
    parser.add_argument(
        "--topic", "-t",
        type=str,
        default="/detector/result_img",
        help="要订阅的图像话题名称 (默认: /detector/result_img)",
    )
    parser.add_argument(
        "--width", "-W",
        type=int,
